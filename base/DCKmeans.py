...
def DCKMeans(data, num_clusters, threshold, num_iterations, seed):
    ...
    while loop_counter < num_iterations:
        ...
        print("Points that actually changed thier membership\n")
        print(len(np.where(new_assigned_clusters != assigned_clusters)[0]))
        print(np.where(new_assigned_clusters != assigned_clusters)[0])
